...
<div class="container" style="margin-top: 90px;">
	<div class="row">
		<div class="col-lg-12">
			<h3 class="black_text"><?php echo get_phrase('Historial de facturación');?></h3>
			<hr>
		</div>
		<div class="col-lg-8">
			<table class="table table-striped table-hover" style="color: #000;">
				<tbody>
					<tr style="background-color: rgb(243, 243, 243); color: #999; border-bottom: 1px solid #ddd;">
						<td><?php echo get_phrase('Fecha');?></td>
						<td><?php echo get_phrase('Paquete');?></td>
						<td><?php echo get_phrase('Periodo del servicio');?></td>
						<td><?php echo get_phrase('Metodo de pago');?></td>
						<td><?php echo get_phrase('Total');?></td>
						<td><?php echo get_phrase('Opciones');?></td>
					</tr>
					<?php 
