			...
			<form method="post" id="form"
				...
				<div class="col-lg-8 col-lg-offset-2">
					<div style="clear: both; padding-top: 100px;">
						<h1><?php echo get_phrase('Editar perfil');?></h1>
					...
					<div class="row">
						...
						<div class="col-lg-9">
							<input type="text" class="input_black" placeholder="Nombre" value="<?php echo $username;?>" name="username" />
							<br><br>

							<span id="filename"><?php echo get_phrase('Subir foto de perfil').' (476 X 476)'; ?></span>
    						<label for="file-upload"><?php echo get_phrase('Navegar'); ?><input type="file" class="input_black" id="file-upload" name = "userimage"></label>
						</div>
					</div>
					<hr style="border-top:1px solid #333;">
					<br>
					<a href="#" class="btn_block" onClick="submit_form()"><?php echo get_phrase('GUARDAR');?></a>
					<a href="<?php echo base_url();?>index.php?browse/manageprofile" class="btn_blank"><?php echo get_phrase('CANCELAR');?></a>
				</div>
			</form>
		</div>
	</div>
