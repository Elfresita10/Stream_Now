	...
	<div class="row">
		...
		?>
			...
			<div class="alert alert-dismissible alert-danger">
			  ...
			  <?php echo get_phrase('El correo electrónico ya existe o la contraseña fue incorrecta. Inténtalo de nuevo');?>
			</div>
		<?php endif;?>
		<div class="col-lg-12">
			<h3 class="black_text"><?php echo get_phrase('Cambiar correo');?></h3>
			<hr>
		</div>
		<div class="col-lg-5">
			<form method="post" action="<?php echo base_url();?>index.php?browse/emailchange">
				<div class="">
					<?php echo get_phrase('Correo actual');?> 
				</div>
				...
				<br>
				<div class="">
					<?php echo get_phrase('Nuevo correo');?> 
				</div>
				<div class="black_text">
