...
<div style="height:100vh;width:100%; background-color: #141414;">
	...
	<div style="clear: both; text-align: center; padding-top: 100px;">
		<h1><?php echo get_phrase('Administrar perfiles');?></h1>
		...
		<br>
		<a href="<?php echo base_url();?>index.php?browse/switchprofile" class="profile_manage_done"><?php echo get_phrase('FINALIZADO');?></a>
	</div>
</div>
