...
<style>
	.movie_thumb{}
	.btn_opaque{font-size:20px; border: 1px solid #939393;text-decoration: none;margin: 10px;background-color: rgba(0, 0, 0, 0.74); color: #050ae7;}
	.btn_opaque:hover{border: 1px solid #939393;text-decoration: none;background-color: rgba(0, 0, 0, 0.74);color:#050ae7;}
</style>
...
<div style="background-image: url(<?php echo $this->crud_model->get_poster_url('movie' , $featured_movie->movie_id);?>); background-size:cover; width: 100%;">
	<div class="mobile_responsive" style="font-weight: bold;color: #fff;">
		...
		<h5 class="mobile_responsive_sort_description" style="color: #fff; max-width: 900px;"><?php echo $featured_movie->description_short;?></h5>
		...
		<b><i class="fa fa-play"></i> <?php echo get_phrase('Reproducir');?></b>
		</a>
