...
<!--required for getting the stripe token-->
          ...
          <form method="post"
            ...
            <label>
                ...
                <span><span><?php echo get_phrase('Tarjeta de débito/crédito');?></span></span>
            </label>
            <button type="submit">
                <?php echo get_phrase('Pagar');?> <?php echo $this->db->get_where('plan', array('plan_id' => $plan_id))->row('price').' '.get_settings('stripe_currency');?>
            </button>
            <div class="outcome">
                <div class="error" role="alert"></div>
                <div class="success">
                  Completado! Tu Token Stripe es <span class="token"></span>
                </div>
            </div>
            <div class="package-details">
                <strong><?php echo get_phrase('Nombre');?> | <?php echo $this->db->get_where('user', array('user_id' => $user_id))->row('name'); ?></strong> <br>
            </div>
