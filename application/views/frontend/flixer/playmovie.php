...
<div class="container" style="margin-top: 30px;">
	<div class="row">
		...
		<div class="col-lg-4">
			...
			<i class="fa fa-plus"></i> <?php echo get_phrase('Añadir a mi lista');?>
			</a>
			</span>
			<button class="btn btn-danger btn-md" id = 'watch_button' style="font-size: 16px; margin-top: 20px;" onclick="divToggle()">
				<i class="fa fa-eye"></i> <?php echo get_phrase('Ver trailer');?>
			</button>
			...
			<i class="fa fa-check"></i> <?php echo get_phrase('Añadido a mi lista');?>
			</a>
			</span>
			<!-- MOVIE GENRE -->
			<div style="margin-top: 10px;">
				<strong><?php echo get_phrase('Genero');?></strong> :
			...
			<!-- MOVIE YEAR -->
			<div>
				<strong><?php echo get_phrase('Año');?></strong> : <?php echo $row['year'];?>
			</div>
		</div>
	</div>
				...
				<ul class="nav nav-tabs">
					<li class="active" style="width:25%;">
						<a href="#about" data-toggle="tab">
							<?php echo get_phrase('Sobre');?>
						</a>
					</li>
					<li style="width:25%;">
						<a href="#cast" data-toggle="tab">
							<?php echo get_phrase('Elenco');?>
						</a>
					</li>
					<li style="width:25%;">
...
<script type="text/javascript">
	function divToggle() {
		if ($('#trailer_div').hasClass('hidden')) {
			...
			$('#watch_button').html('<?php echo '<i class="fa fa-eye"></i> '.get_phrase('Ver pelicula') ?>');
			player.pause();
		}else {
			$('#movie_div').removeClass('hidden');
			$('#trailer_div').addClass('hidden');
			$('#watch_button').html('<?php echo '<i class="fa fa-eye"></i> '.get_phrase('Ver trailer') ?>');
			trailer_url.pause();
		}
