        ...
        <div class="row">
          <div class="col-md-10">
            <p class="credit cookie_text">
              <?php echo get_settings('Nota de Cookies'); ?> <a href="<?php echo base_url();?>index.php?general/cookie_policy" class="cookie_policy"><?php echo get_phrase('politicas de Cookies'); ?></a>
            </p>
          </div>
          <div class="col-md-2" style="padding-top: 5px;">
            <a href="javascript: void()" onclick="allowCookie()" class="btn btn-success btn-sm pull-right"><?php echo get_phrase('Aceptar'); ?></a>
          </div>
        </div>
      </div>
    </div>
