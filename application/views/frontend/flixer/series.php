...
<div class="row" style="margin:20px 60px;">
	<h4 style="text-transform: capitalize;"><?php echo get_phrase('Filtrar por elenco'); ?></h4>
	<div class="content">
		<div class="grid">
			<div class="row">
				...
				<div class="col-md-6 col-lg-2">
					<div class="select" style="width: 100%; margin-bottom: 10px">
						<select name="director_id" id="director_id" class="custom-select">
							<option value="all"><?php echo get_phrase('Todos los directores'); ?></option>
				...
				<div class="col-md-6 col-lg-2">
					<div class="select" style="width: 100%; margin-bottom: 10px">
						<select name="year" id="year" class="custom-select">
							<option value="all"><?php echo get_phrase('Todos los años'); ?></option>
				...
				<div class="col-md-6 col-lg-2">
					<div class="select" style="width: 100%; margin-bottom: 10px">
						...
						<select name="country" id="country" class="custom-select">
							<option value="all"><?php echo get_phrase('Todo los paises'); ?></option>
...
<div class="row" style="margin:20px 60px;">
	<h4 style="text-transform: capitalize;">
		<?php echo $this->db->get_where('genre', array('genre_id' => $genre_id))->row()->name;?>
			<?php echo get_phrase('Series');?> (<?php echo $total_result;?>)
	</h4>
	<div class="content">
		<div class="grid">
			<?php
