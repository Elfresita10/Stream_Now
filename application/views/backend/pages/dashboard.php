	...
	<div class="col-md-4 col-sm-12 ">
		<div class="panel widget-flat">
			<div class="panel-body">
				...
				<h5 class="text-muted font-weight-normal mt-0" title="Number of Customers"><?php echo get_phrase('Total de Peliculas'); ?></h5>
	...
	<div class="col-md-4 col-sm-12 ">
		<div class="panel widget-flat">
			<div class="panel-body">
				...
				<h5 class="text-muted font-weight-normal mt-0" title="Number of Customers"><?php echo get_phrase('Total de Series'); ?></h5>
	...
	<div class="col-md-4 col-sm-12 ">
		<div class="panel widget-flat">
			<div class="panel-body">
				...
				<h5 class="text-muted font-weight-normal mt-0" title="Number of Customers"><?php echo get_phrase('Total de Episodios'); ?></h5>
	...
	<div class="col-md-4 col-sm-12 ">
		<div class="panel widget-flat">
			<div class="panel-body">
				...
				<h5 class="text-muted font-weight-normal mt-0" title="Number of Customers"><?php echo get_phrase('Total de usuarios registrados'); ?></h5>
	...
	<div class="col-md-4 col-sm-12 ">
		<div class="panel widget-flat">
			<div class="panel-body">
				...
				<h5 class="text-muted font-weight-normal mt-0" title="Number of Customers"><?php echo get_phrase('Total de suscripciones activas'); ?></h5>
				<h3 class="mt-3 mb-3">
					<?php
	...
	<div class="col-md-4 col-sm-12 ">
		<div class="panel widget-flat">
			<div class="panel-body">
				...
				<h5 class="text-muted font-weight-normal mt-0" title="Number of Customers"><?php echo get_phrase('Ventas este mes'); ?></h5>
				<h3 class="mt-3 mb-3">
					<?php
						$total_sale	=	0;
						$month			=	date("F");
