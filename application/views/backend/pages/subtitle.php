			...
			<tbody>
				...
				<tr>
					...
					<td>
						...
						Editar</a>
						<a href="<?php echo base_url();?>index.php?admin/delete_subtitle/<?php echo $row['id'];?>/<?php echo $row['movie_id'];?>" class="btn btn-danger" onclick="return confirm('Quieres eliminarlo?')">
						Eliminar</a>
					</td>
				</tr>
				<?php endforeach;?>
