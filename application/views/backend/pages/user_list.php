...
<div class="panel panel-primary">
	<div class="panel-heading">
		<div class="panel-title">
			<?php echo get_phrase('Lista de Usuarios'); ?>
		</div>
	</div>
			...
			<tbody>
				...
				<tr>
					...
					<td>
						...
						Editar</a>
						<a href="<?php echo base_url();?>index.php?admin/user_delete/<?php echo $row['user_id'];?>" class="btn btn-danger" onclick="return confirm('Quieres eliminarlo?')">
						Eliminar</a>
					</td>
				</tr>
				<?php endforeach;?>
