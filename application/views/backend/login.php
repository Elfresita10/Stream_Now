...
<body>
<div class="wrapper" background="#00046";>
                ...
                <div class="row no-gutters justify-content-center">
                    ...
                    <div class="col-lg-4 col-md-6 white-bg">
                        <div class="login-fancy pb-40 clearfix" id = "login_area">
                            <h3 class="mb-30"><?php echo get_phrase('Iniciar Sesión'); ?></h3>
                            <form class="" action="<?php echo base_url();?>index.php?home/signin/admin" method="post">
                                <div class="section-field mb-20">
                                    <label class="mb-10" for="name"><?php echo get_phrase('Correo'); ?>* </label>
                                    <input id="email" class="web form-control" type="email"  <?php echo get_phrase('email'); ?>" name="email" required>
                                </div>
                                <div class="section-field mb-20">
                                    <label class="mb-10" for="Password"><?php echo get_phrase('Contraseña'); ?>* </label>
                                    <input id="Password" class="Password form-control" type="password" <?php echo get_phrase('password'); ?>" name="password" required>
                                </div>
                                <?php if(get_settings('recaptcha')): ?>
                                ...
                                <?php endif; ?>
                                <button type="submit" class="btn btn-success"><?php echo get_phrase('Iniciar sesión'); ?></button>
                            </form>

                            <div class="section-field">
                                <div class="remember-checkbox mb-30">
                                    <a href="#" class="float-right" id = "forgot_password_button" onclick="toggleView(this)" style="color: black;"><?php echo get_phrase('Olvidó contraseña?'); ?>?</a>

                                    <a href="<?php echo base_url();?>" class="float-left" style="color: black;">
                                        <i class="entypo-left-open"></i><?php echo get_phrase('Volver al menú principal'); ?></a>
                                </div>
                            </div>
                        </div>

                        <div class="login-fancy pb-40 clearfix" id = "forgot_password_area" style="display: none;">
                            <h3 class="mb-30"><?php echo get_phrase('Olvidó contraseña?'); ?></h3>
                            <form class="" action="<?php echo base_url();?>index.php?home/forget/admin" method="post">
                                ...
                                <button type="submit" class="btn btn-primary"><?php echo get_phrase('Enviar mensaje de recuperación'); ?></button>
                            </form>

                            <div class="section-field">
                                <div class="remember-checkbox mb-30">
                                    <a href="#" class="float-right" id = "login_button" onclick="toggleView(this)" style="color: black;"><?php echo get_phrase('Volver al inicio de sesión'); ?>?</a>
                                </div>
                            </div>
                        </div>
                    </div>
