                                    ...
                                    <tr>
                                        <td class="content-cell">
                                            <div class="f-fallback">
                                              ...
                                              <p>Bienvenido a <a title="<?= get_settings('site_name'); ?>" target="_blank" href="<?= site_url(); ?>"><?= get_settings('site_name'); ?></a>. Nos encantaría asegurarnos de tener el correo electrónico adecuado para usted.</p>
                                              <br>
                                              <p>Su codiog de verificación es <b style="cursor: pointer;" ><u><?= $verification_code; ?></u></b></p>
